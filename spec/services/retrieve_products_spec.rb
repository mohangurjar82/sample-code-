  ...
  describe '#call' do
    ...
    it 'creates product with items' do
      entry = {"id"=>"http://data.product.theplatform.com/product/data/Product/22230892",
        ...
        "pricingPlan"=>{"isTaxIncluded"=>false,"isRecurring"=>false,"pricingTiers"=>[{"absoluteStart"=>1455150720000,"absoluteEnd"=>1483160400000,"rightsIds"=>["http://data.entitlement.theplatform.com/eds/data/Rights/62384649"],"subscriptionUnits"=>"month","billingFrequency"=>0,"minimumSubscriptionPeriod"=>0,"productTagIds"=>[],"productTags"=>[],"amounts"=>{"USD"=>14.99},"isBlackout"=>false,"isActive"=>true}],"masterAgreementStartDate"=>1455080400000,"masterAgreementEndDate"=>1483160400000,"masterProductTagIds"=>[]},        
